<div _="on closeModal add .closing wait for animationend then remove me" class="modal">
    ...
    <div class="content">
        ...
        <form hx-delete="<?= BASE_PATH ?>/student/<?= $id ?>" class="mx-auto text-center py-5" hx-trigger="submit" hx-on::after-request="htmx.trigger(htmx.find('body'), 'doReloadStudentTable')">
            ...
            <div class="flex gap-4 mt-5 items-center justify-center">
                <input name="nim" value="<?= $id ?>" type="hidden">
