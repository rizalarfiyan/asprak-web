...
class Students {
	...
	{
		$this->db->query("SELECT s.nim, s.name  AS name, gender, date_of_birth, location_of_birth, address, sp.name AS study_program, s.hobby FROM students s JOIN study_programs sp ON s.study_program_id = sp.id");
